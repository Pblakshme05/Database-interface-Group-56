...
// If POST update, reload the edited row
...
body, input, button, select { font-family: 'Poppins', sans-serif; }
body {
    min-height: 100vh;
...
.edit-title { color: white; font-size: 16px; font-weight: 600; margin-bottom: 18px; }
...
.field input {
    ...
    border: 1px solid rgba(255,255,255,0.18); padding: 0 12px;
    background: rgba(15, 30, 70, 0.65); color: white;
    font-family: 'Poppins', sans-serif; font-size: 14px; outline: none; transition: border-color 0.2s;
}
.field input:focus { border-color: rgba(100, 150, 255, 0.5); }
.form-row { display: flex; gap: 12px; align-items: flex-end; }
.form-row .field { flex: 1; margin-bottom: 0; }
.btn-submit {
    height: 45px; padding: 0 24px; border-radius: 10px;
    border: 1px solid rgba(255,255,255,0.2); background: rgba(50, 80, 150, 0.55);
...
.message.success {
    background: rgba(50, 180, 100, 0.25); border: 1px solid rgba(50, 200, 100, 0.3); color: #7fffa0;
}
.message.error {
    background: rgba(220, 60, 60, 0.25); border: 1px solid rgba(220, 80, 80, 0.3); color: #ffaaaa;
}
...
.btn-return {
    ...
    color: white; font-size: 13px; font-weight: 500; font-family: 'Poppins', sans-serif;
    cursor: pointer; text-decoration: none; margin-bottom: 14px;
    transition: background 0.2s, border-color 0.2s;
}
.btn-return:hover {
    background: rgba(255,255,255,0.16); border-color: rgba(255,255,255,0.4); color: white;
}
.result-box { text-align: center; padding: 40px 20px; color: white; }
...
<?php if (isset($deleteSuccess)): ?>
    ...
    <!-- DELETE SUCCESS SCREEN (same pattern as Manage Students) -->
    ...
    <div class="card" style="max-width:480px; margin:0 auto;">
        <div class="result-box">
            ...
            <p>The assessor info has been removed from the database.</p>
            <a href="Manage_Assessors.php" class="btn-return" style="margin-bottom:0;">&#8592; Return to Manage Assessors</a>
        </div>
    </div>

<?php else: ?>

    <div class="page-header"><h2>Manage Assessors</h2></div>
