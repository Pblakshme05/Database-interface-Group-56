...
<style>
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  body { background: var(--bg); color: var(--ink); min-height: 100vh; font-size: 16px; }
  ...
  .admin-pill {
    ...
    border: 1px solid #e8d99a; padding: 5px 14px; border-radius: 20px;
  }

  .main { max-width: 960px; margin: 2.5rem auto; padding: 0 20px 60px; }
  ...
  thead th {
    ...
    letter-spacing: 0.06em; padding: 16px 20px; text-align: left;
  }
  tbody tr { border-bottom: 1px solid var(--border); transition: background 0.12s; }
  tbody tr:last-child { border-bottom: none; }
  tbody tr:hover { background: #f8f9fc; }
  td { padding: 15px 20px; font-size: 15px; vertical-align: middle; }
  ...
  .edit-card {
    ...
    box-shadow: 0 2px 6px rgba(0,0,0,0.04); margin-top: 1.5rem;
  }
  .edit-title { font-size: 16px; font-weight: 700; color: var(--ink); margin-bottom: 1.4rem; }
  ...
  .no-data { text-align: center; padding: 3rem; color: var(--ink-soft); font-size: 15px; }
  ...
  .result-card h2 { font-size: 1.2rem; font-weight: 700; color: var(--green); margin-bottom: 8px; }
  .result-card p  { font-size: 15px; color: var(--ink-soft); margin-bottom: 1.5rem; }
  .btn-return {
    ...
    <table>
      ...
      <tbody>
        <?php if (count($allAssessors) > 0): ?>
          ...
          ?>
          <tr>
            <td style="color:var(--ink-soft); font-size:14px;"><?= htmlspecialchars($assessor['assessor_id']) ?></td>
            <td>
            ...
            <td style="color:var(--ink-soft); font-size:15px;"><?= htmlspecialchars($assessor['email']) ?></td>
            <td>
              <div class="actions">
