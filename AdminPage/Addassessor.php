...
<style>
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .section-header p { font-size: 14px; color: var(--ink-soft); margin-top: 4px; }
...
<div class="topbar">
  <div class="topbar-left">
    ...
    <span class="page-title">Add Assessor</span>
  </div>
...
<div class="main">
  ...
  <div class="card">
    <div class="card-title">Register a new assessor</div>
    <div class="card-sub">Fill in the details below to create a new assessor account.</div>

    <form method="post">
      <div class="field">
        <label>Assessor Name</label>
        <input type="text" name="name" placeholder="Enter assessor name" value="<?= htmlspecialchars($_POST['name'] ?? '') ?>">
      </div>
      <div class="field">
        <label>Email</label>
        <input type="email" name="email" placeholder="Enter email" value="<?= htmlspecialchars($_POST['email'] ?? '') ?>">
      </div>
      <div class="field">
        <label>Password</label>
        <input type="password" name="password" placeholder="Enter password">
      </div>
      <button type="submit" class="btn-submit">Add Assessor</button>
    </form>
  </div>
</div>
